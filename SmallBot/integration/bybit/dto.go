...
// BybitOrderInfoResponse представляет ответ с информацией об ордере
type BybitOrderInfoResponse struct {
	NextPageCursor string        `json:"nextPageCursor"`
	Category       string        `json:"category"`
	List           []BybitOrderInfo `json:"list"`
}

// BybitOrderInfo представляет детальную информацию об ордере
